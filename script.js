    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בריאלי – הדרך הקלה לגוף בריא משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '81c321dc-a33c-4d32-92d7-c523c3c8d540',
                    name: data.name || '',
                    email: data.email || '',
